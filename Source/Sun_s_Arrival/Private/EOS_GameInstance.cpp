...
void UEOS_GameInstance::LoginWithEOS(const FString& _id, const FString& _token, const FString& _loginType)
{
	...
	_accoundDetails.Id = _id;
	_accoundDetails.Token = _token;
	_accoundDetails.Type = _loginType;
